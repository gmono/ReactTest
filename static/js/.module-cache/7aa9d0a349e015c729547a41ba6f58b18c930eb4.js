...
var Hander=React.createClass({displayName: "Hander",
    ...
    getLine:function(name,value){
        ...
        return React.createElement("div", {style: {height:'20px',lineHeight:'20px'}}, React.createElement("span", {style: sty}, name), React.createElement("span", {style: sty}, value));
    }
});
...
var NavBar=React.createClass({displayName: "NavBar",
    render:function(){
        ...
        React.createElement(NavButton, {name: "主页", imgsrc: ""}), 
